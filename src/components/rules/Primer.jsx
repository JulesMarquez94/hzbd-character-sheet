...
const STEPS = [
  ['Create the character', 'On your dashboard, press Create Character, choose a way in and give it a name. If your Game Master gave you a campaign\u2019s join code, enter it there too. The Walkthrough asks each choice with the rules beside it, saving as you go. The Crossroads asks about the life they led instead, and makes a level 2 character from your answers. The Free Hand makes a character above level 1, with every choice up to that level open at once.'],
