 ...
 */
const FAMILY_FOLDERS = new Set(['shadow', 'time', 'space', 'death', 'flora']);
 ...
 * 2400x1792 and `data/Flora/` is four more at the same.
 *
 ...
 * the same way.
 */
const PLATE_FOLDERS = new Set(['ethereal', 'shadow', 'time', 'space', 'death', 'flora']);
